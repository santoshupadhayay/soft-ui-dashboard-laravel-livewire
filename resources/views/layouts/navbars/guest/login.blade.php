<nav
    ...
    <div class="container-fluid">
        <a class="navbar-brand font-weight-bolder ms-lg-0 ms-3 " href="{{ Auth::user() ? route('dashboard') : route('kzapp') }}">
            <img src="../assets/img/kzlogo.png" style="width: 7%" class="navbar-brand-img" alt="...">  
        </a>
